    ...
    <div className="font-poppins flex flex-col h-screen overflow-hidden pt-16 xl:pt-4">
      ...
      <header className="bg-gradient-to-r from-violet-950 via-violet-700 to-violet-500 px-5 py-7 text-center shrink-0">
        <div className="flex justify-center items-center gap-2.5 mb-2">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white m-0">
            SmartCoach360 Legal Portal
          </h1>
        </div>
        <p className="text-violet-200 text-sm m-0">Privacy Policy</p>
      </header>
      ...
      {sidebarOpen && (
        <div className="md:hidden fixed inset-0 z-50 flex">
          <div className="w-72 bg-white h-full overflow-y-auto shadow-xl shadow-violet-500/20">
            <div className="px-4 py-4 border-b border-violet-100 flex justify-between items-center">
              ...
              <button
                ...
                className="bg-transparent border-none cursor-pointer text-violet-600"
              >
                <X size={20} />
              </button>
            </div>
          ...
          <div
            className="flex-1 bg-violet-900/35"
            onClick={() => setSidebarOpen(false)}
          />
        </div>
      )}
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="px-4 pb-5 flex-1">
            <div className="pl-2 mt-1">
              ...
              <div className="border-t border-violet-200 pt-3">
                <p className="text-[11px] font-bold text-violet-800 uppercase tracking-widest px-2.5 mt-0 mb-1.5">
                  Sections
                </p>
                {sections.map((s) => (
                  <button
        ...
        <main ref={contentRef} className="flex-1 overflow-y-auto bg-white">
          <div className="font-poppins max-w-3xl mx-auto px-6 md:px-8 pt-10 pb-20">
            ...
            <h1 className="text-3xl md:text-[32px] font-extrabold text-violet-900 mb-1.5">
              Privacy Policy
            </h1>
            <p className="text-[15px] font-semibold text-violet-700 mb-5">SmartCoach360</p>
            ...
            <SectionBlock id="user-info" num="02" title="User Information" icon={UserCircle} sectionRefs={sectionRefs}>
              ...
              <BulletList
                items={[
                  ...
                  "Contact us forms",
                  "Other contact with customer support",
                ]}
              />
              <P>
              ...
              <BulletList
                items={[
                  ...
                  "Payment method and transactional details",
                ]}
              />
            ...
            <SectionBlock id="sharing" num="03" title="Sharing & Disclosure of Data with Third Parties" icon={Share2} sectionRefs={sectionRefs}>
              ...
              <P>
                We may use the information we have about you for marketing purposes, but only with
                your express consent. You can opt-out at any time by:
              </P>
              <BulletList
                items={[
            ...
            <SectionBlock id="health-purpose" num="06" title="Purpose of Health Data Access" icon={Target} sectionRefs={sectionRefs}>
              ...
              <BulletList
                items={["Daily steps", "Daily activity", "Calories", "Sleep patterns"]}
              />
              <Callout>
            ...
            <SectionBlock id="contact" num="11" title="Contact & Policy Updates" icon={Phone} sectionRefs={sectionRefs}>
              ...
              <p className="text-sm font-semibold text-violet-900 mt-4 mb-2">
                Registered Address
              </p>
              <AddressBlock />
            </SectionBlock>
            ...
            <div className="border-t border-violet-100 pt-5 text-center">
              <p className="text-[13px] text-violet-400 m-0">— End of Privacy Policy —</p>
            </div>
